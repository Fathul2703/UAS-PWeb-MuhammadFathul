...
<body>
        ...
        <div class="row">
            <div class="glass-effect col-2 ">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <span class="nav text-white  bg-dark p-2">Kelola Data Peminjam</span>
                    </li>
                    <li class="nav-item">
                        <span class="fa-solid fa-magnifying-glass"></span>
  ...
  ?>
                ...
                <form class="mt-5" action="../proses/pembiayaan-edit-proses.php?id_pembiayaan=<?= $id_pembiayaan ?>"
                    ...
                    <div class="mt-4">
                        <button class="btn btn-sm btn-primary mx-2" name="submit">Edit Data</button>
